const items = [
  {
    ...
    price: { oldUan: "4 333 руб", newUan: "3 799 руб" },
  ...
  },
  {
    ...
    price: { oldUan: "3 495 руб", newUan: "2 995 руб" },
    name: "Lenovo K5 (A6020a40) Silver",
  },
  {
    ratingRevievs: "352 отзыва",
    price: { oldUan: "9 799 руб", newUan: "7 999 руб" },
  ...
  },
  {
    ...
    price: { oldUan: "24 999 руб", newUan: "22 999 руб" },
  ...
  },
  {
    ...
    price: { oldUan: "7 399 руб", newUan: "5 999 руб" },
    name: "Asus ZenFone 2 32GB (ZE551ML) Black",
  },
  {
    ratingRevievs: "45 отзывов",
    price: "4 299 руб",
    name: "Nokia 3 Dual Sim Silver White + сертификаты 500 руб!",
  },
  {
  ...
  },
  {
    ...
    price: { oldUan: "9 999 руб", newUan: "7 999 руб" },
  ...
  },
  {
    ...
    price: "16 999 руб",
    name: "Huawei P10 4/32GB Black + сертификат 2500руб + чехол Huawei Smart View Cover!",
  },
  {
    ratingRevievs: "71 отзыв",
    price: { oldUan: "2 399 руб", newUan: "1 999 руб" },
  ...
  },
  {
    ...
    price: { oldUan: "10 999 руб", newUan: "9 999 руб" },
    name: "HTC One X10 Dual Sim Silver",
  },
  {
    ratingRevievs: "18 отзывов",
    price: { oldUan: "5 999 руб", newUan: "4 999 руб" },
